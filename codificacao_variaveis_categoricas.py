...
educacao_ordem = {'Ensino Fundamental': 1, 'Ensino Médio': 2, 'Ensino Superior': 3, 'Pós-Graduação': 4, 'Mestrado': 5,
                  'Doutorado': 6}
...
df['area_atuacao_ordinal'] = df['area_atuacao'].astype('category').cat.codes

print("\nDataFrame após transforma 'area_atuacao' em códigos numéricos:\n", df.head())
